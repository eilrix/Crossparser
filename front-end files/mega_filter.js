...
MegaFilter.prototype = {
	...
	*/
	...
	__initLoader: function() {
		...
		this._jqLoader = jQuery('<span class="mfilter-ajax-loader-container" style="cursor: wait; z-index: 100; margin: 0; padding: 0; position: absolute; text-align: center; background-color: rgba(0,0,0,0.4);"></span><script type="text/javascript">/*setTimeout( ()=>{reloadShowMoreAfterFilter();}, 2500);*/</script>')
